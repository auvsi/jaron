...
"""autogenerated by genpy from opencv_stuff/MyImage.msg. Do not edit."""
import sys
...
class MyImage(genpy.Message):
  _md5sum = "2344f5b8ab970a363dd7f4dc1ca716cb"
  _type = "opencv_stuff/MyImage"
  _has_header = False #flag to mark the presence of a Header object
  _full_text = """uint8 imageId
...
"""
  __slots__ = ['imageId','image']
  _slot_types = ['uint8','sensor_msgs/Image']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(MyImage, self).__init__(*args, **kwds)
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_struct_B3I.pack(_x.imageId, _x.image.header.seq, _x.image.header.stamp.secs, _x.image.header.stamp.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.imageId, _x.image.header.seq, _x.image.header.stamp.secs, _x.image.header.stamp.nsecs,) = _struct_B3I.unpack(str[start:end])
      start = end
      end += 4
